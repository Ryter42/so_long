...
/*   Updated: 2023/04/01 05:55:42 by emoreau          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	// mlx_ptr = mlx_init();
	// win_ptr = mlx_new_window(mlx_ptr, 1920, 1920, "My first window!");
	// img = mlx_xpm_file_to_image(mlx_ptr, "./srcs/global.xpm", &img_width, &img_height);
	// while (1)
